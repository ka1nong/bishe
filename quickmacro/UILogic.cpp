...
void TForm1::loadProgress()
{
        ...
        Form1->mouseEventFilter->AddItem("È«²¿", Form1->mouseEventFilter);
        Form1->mouseEventFilter->AddItem("ÓÒ¼üµ¥»÷", Form1->mouseEventFilter);
        Form1->mouseEventFilter->AddItem("ÓÒ¼üË«»÷", Form1->mouseEventFilter);
        Form1->mouseEventFilter->AddItem("×ó¼üµ¥»÷", Form1->mouseEventFilter);
        Form1->mouseEventFilter->AddItem("×ó¼üË«»÷", Form1->mouseEventFilter);
        Form1->mouseEventFilter->AddItem("Êó±êÒÆ¶¯", Form1->mouseEventFilter);
        Form1->mouseEventFilter->SelText = "È«²¿";
}
